...
async def status(event):
  ...
  time.sleep(1)
  msg = await event.reply('Portable Psychological.')
  time.sleep(1)
  msg = await event.reply('Portable Psychological Diagnosis.')
  time.sleep(1)
  msg = await event.reply('Portable Psychological Diagnosis and.')
  time.sleep(1)
  msg = await event.reply('Portable Psychological Diagnosis and Suppression.')
  time.sleep(1)
